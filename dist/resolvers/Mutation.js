...
var Mutation = {
          ...
          switch (_context.prev = _context.next) {
            ...
            case 5:
              ...
              return _context.abrupt("return", {
                user: user,
                token: _jsonwebtoken2.default.sign({ userId: user.id }, "secret1", { expiresIn: "7d" })
              });
      ...
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return prisma.query.user({ where: { email: args.data.email } });
            ...
            case 10:
              return _context2.abrupt("return", {
                user: user,
                token: _jsonwebtoken2.default.sign({ userId: user.id }, "secret1", { expiresIn: "10d" })
              });
  ...
  updatePost: function () {
    var _ref14 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(parent, args, _ref13, info) {
      ...
      var userid, postexists, publishedPost;
